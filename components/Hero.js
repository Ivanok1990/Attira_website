...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-[#F6F6F6] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        ...
        <div className="mt-8 flex items-center gap-6">
          ...
          <button className="bg-[#8B3A4F] text-black px-6 py-3 rounded-full font-medium hover:bg-[#7e4e4b] transition">
          Empieza gratis
          </button>

          <button className="text-[#F6F6F6] hover:text-white transition">
            Ver Mas ↓
          </button>
